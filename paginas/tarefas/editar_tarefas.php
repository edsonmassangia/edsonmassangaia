...
<header>
    ...
    <div>
        <form class="needs-validation" action="index.php?menuop=atualizar_tarefa" method="post" novalidate>
        <div class="mb-3">
                <label for="idTarefa" class="form-label">Título</label>
            ...
            <div class="row">
                <div class="mb-3 col-3">
                    <label for="dataLembreteTarefa" class="form-label">Data Lembrete</label>
                    <input class="form-control" type="date" name="dataLembreteTarefa" value="<?=$dados['dataLembreteTarefa']?>"id="dataLembreteTarefa">
                </div>
                <div class="mb-3 col-3">
                    <label for="horaLembreteTarefa" class="form-label">Hora Lembrete</label>
                    <input class="form-control" type="time" name="horaLembreteTarefa" value="<?=$dados['horaLembreteTarefa']?>"id="horaLembreteTarefa">
                </div>
            </div>
            <div class="row">
                <div class="mb-3 col-3">
