...
$statusEvento = (isset($_GET['statusEvento']) and $_GET['status']=='0')?'1':'0';
...
<div>
    <a class="btn btn-outline-secondary mb-2" href="index.php?menuop=cad_evento"><i class="bi bi-calendar-check"></i> Novo Evento</a>
</div>
<div>
...
<table class="table table-dark table-striped table-bordered table-sm ">
    ...
    ?>
        <tr>
            <td>
               <a class="btn btn-secondary btn-sm" href="index.php?menuop=eventos&pagina<?=$pagina?>&idEvento=<?=$dados['idEvento']?>&status=<?=$dados['statusEvento']?>">
                    <?php
            ...
            <td class='text-center'><a class='btn btn-outline-warning btn-sm' href="index.php?menuop=editar_evento&idEvento=<?=$dados["idEvento"] ?>"><i class="bi bi-pencil-square"></i></a></td>
            <td class='text-center'><a class='btn btn-outline-danger btn-sm'href="index.php?menuop=excluir_evento&idEvento=<?=$dados["idEvento"] ?>"><i class="bi bi-trash-fill"></i></a></td>
        </tr>
    <?php
        }
    ?>
