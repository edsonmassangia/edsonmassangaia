...
<header>
    ...
    <div>
        <form class="needs-validation" action="index.php?menuop=atualizar_evento" method="post" novalidate>
        <div class="mb-3">
                <label for="idEvento" class="form-label">Título</label>
            ...
            <div class="row">
                <div class="mb-3 col-3">
                    ...
                    <input class="form-control" type="date" name="dataFimEvento" value="<?=$dados['dataFimEvento']?>"id="dataFimEvento">
                </div>
                <div class="mb-3 col-3">
                    <label for="horaFimEvento" class="form-label">Hora Fim</label>
                    <input class="form-control" type="time" name="horaFimEvento" value="<?=$dados['horaFimEvento']?>"id="horaFimEvento">
                </div>
            </div>
